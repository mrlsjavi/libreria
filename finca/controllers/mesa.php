...
class Mesa extends Controller{
	...
	function __construct(){
		...
		$this->view->js = array('mesa/js/funcionalidad_formulario.js', 'mesa/js/buscador.js');
	...
	function buscar(){
		//echo "javier";
		echo '<h1>Buscar Mesa</h1>
				<div class="cf form-horizontal" obj="Item" acc="4">
					<div class="form-group">
						<label class="col-sm-2 control-label">nombre de la mesa: </label>
